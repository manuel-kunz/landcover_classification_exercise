...
#### 1.3 Model training
First, the data was split into training and testing data splits using the {rsample} package. Then, the model was defined as following: To create the model, the {parsnip} R package was used.
```{r, model sturcture, echo=TRUE, message=FALSE, warning=FALSE}
library(parsnip)
