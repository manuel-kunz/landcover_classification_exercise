...
saveRDS(validation_sites, (here::here("./data/validation_sites.rds")))
...
saveRDS(validation_selection, (here::here("./data/validation_filtered.rds")))
...
saveRDS(validation_selection, (here::here("./data/validation_selection.rds")))
...
saveRDS(train, (here::here("./data/training_data_original.rds")))
saveRDS(test, (here::here("./data/test_data_original.rds")))
...
saveRDS(model_settings, (here::here("./data/model_settings.rds")))
...
print(xgb_workflow)
saveRDS(xgb_workflow, (here::here("./data/xgb_workflow.rds")))
...
saveRDS(hp_settings, (here::here("./data/hp_settings.rds")))
...
saveRDS(folds, (here::here("./data/folds.rds")))
...
saveRDS(xgb_results, (here::here("./data/xgb_results.rds")))
...
print(xgb_best)
saveRDS(xgb_best, (here::here("./data/xgb_best.rds")))
...
saveRDS(xgb_best_hp, (here::here("./data/xgb_best_hp.rds")))
...
saveRDS(xgb_best_model, (here::here("./data/xgb_best_model.rds")))
...
saveRDS(confusion_matrix, (here::here("./data/confusion_matrix.rds")))
